...
- All you will ever see and hear are hallucinations
...
- No „video feed"
- No lossless storage, we think with memory
- As much chemical as electrical
- Extremely parallel
- Mostly parallel, not serial
...
- Not processing data, but processing change, even rewarding it
...
- Only two areas that create new neurons
- Neuroplasticity happens mostly by improving existing connections
...
- Adaptations from the past, not very well suited for todays lives or paragliding
- Some very energy inefficient constructs
...
- Consciousness has very little access to that decision process
- A process called "confabulation“ (basically lying) makes consciousness feel in control
...
- A strong superhighway is connecting both sides
- Many areas from different sides are better connected than areas of same side
- The left side is always the dominant one as it contains the language center
- The right side has longer neurons, which make it more creative, the left is more rational
...
- Suppressing fear inducing experiences creates traumatic memories you can track or solve anymore
- Transform fearful experiences into learning experiences
...
- Time is bundled into blocks of 200ms to 3 second
...
- Subconscious processes are fast, energy efficient and biased
...
- Luck, randomness plays a bigger role than many think
...
- Speedbar broke? I had the most amazing glide from Daramshala to Bir in the flats
...
- It may feel boring crossing the same valley a dozen times in the same day, but that is what learning is.
...
- You have to revisit every skill or the bubble shrinks again
...
- Create triggers that make you switch tasks (thermal gets slower etc.)
...
- Training is conscious, focues and using repetition
- ...
- Train thermaling
- Train valley crossings
- Train gliding on speedbar (with enough altitude)
- Train spotting birds thermaling
- ...
- Retrain skills to overcome plateaus
...
- Altitude is your friend, is secure, makes you fly far …
- Getting cold means unstable and strong thermals
- The best days are when you freeze high up and sweat low down
- Framing is basically nothing else than using confabulation to our advantage
...
- Priming changes which prediction networks are used
- Say „thermal“ out loud to find thermals
- Plan for 150 km if you want to fly 100 km
- Do the Skyman pose on takeoff
- A turbulent day makes you better a tolerating turbulence (accustomation effect)
...
- Makes it easier to remember hard to remember stuff like numbers
...
- Welcome them!
- Read about stoicism and become a fan ;-)
